...
class gsp_yzf_layoutsmain_h_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/main_h.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(10)
invokeTag('javascript','g',19,['library':("bootstrap")],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1402816451247L
