          ...
          <div class="col-xs-12 col-sm-10 col-md-5">
              <div class="panel panel-default">
                  <div class="panel-heading text-center" style="height:80px;background: #76C68c;">
                    <h3><strong>业之峰工程管理平台</strong></h3>
                  </div>
                  <div class="panel-body">
                      <div style="color: red">${flash.message}</div>
                      <form role="form" action="${contextPath}/weixin/dologin" method="POST" id="login_form">
                          <div class="form-group">
                              <div class="input-group">
                                  <span class="input-group-addon">帐号</span>
                                  <input type="text" class="form-control" placeholder="账号" name="account" id="loginUsername"
                          ...
                          <div class="form-group">
                              <div class="input-group">
                                  ...
                                  <input type="password" class="form-control" placeholder="密码" value="" name="password" id="loginPassword"
                                         onkeydown="onKeyDownFun(this)"
                                         onblur="onBlurFun(this)"
