package com.yzfsys.app.uploadservice;
...
public class UploadService extends IntentService {
    ...
    protected static final String ACTION_UPLOAD = "com.yzfsys.app.uploadservice.action.upload";
    ...
    public static final String BROADCAST_ACTION = "com.yzfsys.app.uploadservice.broadcast.status";
    ...
    private void handleFileUpload(final String uploadId,
        ...
        try {
            ...
            final String serverResponseContent = getResponseContent(responseStream);
    ...
    private String getResponseContent(InputStream in) {
    ...
    private void broadcastCompleted(final String uploadId, 
